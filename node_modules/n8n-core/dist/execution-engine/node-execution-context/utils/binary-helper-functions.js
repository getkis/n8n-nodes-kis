...
function assertBinaryData(inputData, node, itemIndex, parameterData, inputIndex) {
...
async function getBinaryDataBuffer(inputData, itemIndex, parameterData, inputIndex) {
    let binaryData;
    if (isBinaryData(parameterData)) {
